...
public class TopicModeler {
	...
	public static void main(String[] args) throws Exception {
		...
		String line;
		Gson gson = new Gson();
		Type malletInstanceType = new TypeToken<Instance>() {}.getType();
		...
		String[] categoriesArray = {"Restaurants", "Nightlife", "Bars", "Arts_&_Entertainment", "Hotels_&_Travel", "Shopping", "Casinos", "Beauty_&_Spas", "Automotive", "Health_&_Medical", "Home_Services", "Performing_Arts","Grocery", "Fashion", "Fitness_&_Instruction"};
		...
		for (File malletFile : malletFiles){
			...
			allInstanceLists.put(currentCategory, TopicModeler.createInstanceList());
			InstanceList currentInstanceList = allInstanceLists.get(currentCategory);
			...
			// prior.
			int numTopics = 20;
			ParallelTopicModel currentModel = new ParallelTopicModel(numTopics, 1.0, 0.01);
